                ...
                <form action="configurar.php" method="post">
                    <div class="row align-items-end">
                        ...
                        <div class="col-xxl-4 col-xl-4 col-lg-4 col-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="cambioautor" name="cambioautor" aria-describedby="cambioautor" required>
                        </div>
                        <div class="col-xxl-4 col-xl-4 col-lg-4 col-6 mb-3">
                ...
                <form action="configurar.php" method="post">
                    <div class="row align-items-end">
                        <div class="col-8 mb-3">
                            ...
                            <input type="text" class="form-control" id="nuevoautor" name="nuevoautor" aria-describedby="nuevoautor" placeholder="ej: Borges, Jorge Luis" required>
                        </div>
                ...
                <form action="configurar.php" method="post">
                    <div class="row align-items-end">
                        ...
                        <div class="col-xxl-4 col-xl-4 col-lg-4 col-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="cambioeditorial" name="cambioeditorial" aria-describedby="cambioeditorial" required>
                        </div>
                        <div class="col-xxl-4 col-xl-4 col-lg-4 col-6 mb-3">
                ...
                <form action="configurar.php" method="post">
                    <div class="row align-items-end">
                        <div class="col-8 mb-3">
                            ...
                            <input type="text" class="form-control" id="nuevaeditorial" name="nuevaeditorial" aria-describedby="nuevaeditorial" placeholder="ej: ECC Ediciones" required>
                        </div>
                        <div class="col-4 mb-3">
                    ...
                    <form action="configurar.php" method="post">
                        <div class="row align-items-end">
                            ...
                            <div class="col-xxl-4 col-xl-4 col-lg-4 col-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="cambiotag" name="cambiotag" aria-describedby="cambiotag" required>
                            </div>
                            <div class="col-xxl-4 col-xl-4 col-lg-4 col-6 mb-3">
                    ...
                    <form action="configurar.php" method="post">
                        <div class="row align-items-end">
                            <div class="col-8 mb-3">
                                ...
                                <input type="text" class="form-control" id="nuevatag" name="nuevatag" aria-describedby="nuevatag" placeholder="ej: Educación para la Ciudadanía" required>
                            </div>
                            <div class="col-4 mb-3">

...
<main label="cargarlibros">
  ...
  <section>
    ...
    <div class="card shadow border border-dark">
      <div class="card-header text-bg-dark">Cargar un nuevo libro</div>
      <div class="card-body">
              ...
              while ($tags = mysqli_fetch_array($get_tags)) { ?>
                <div class="col-6">
                  <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="tags[]" value="<?= $tags['tag'] ?>" id="color_red" />
          ...
          <div class="alert alert-warning">
            <div class="row align-items-end">
              ...
              <div class="col-xxl-3 xol-xl-3 col-lg-3 col-6 mb-3">
                ...
                <input type="number" class="form-control" id="ejemplares" name="ejemplares" aria-describedby="ejemplares" min="1" value="1" required>
              </div>
              <div class="col-xxl-3 xol-xl-3 col-lg-3 col-6 mb-3">
                <label for="inventario" class="form-label">Inventario inicial</label>
                <input type="number" class="form-control" id="inventario" name="inventario" aria-describedby="inventario" min="1" value="1" required>
              </div>
              ...
              <div class="col-xxl-3 xol-xl-3 col-lg-3 col-6 mb-3">
                ...
                <input type="date" class="form-control" id="fechaalta" name="fechaalta" aria-describedby="fechaalta" value="<?= $dt ?>" required>
              </div>
            </div>
          </div>

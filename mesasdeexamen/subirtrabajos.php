...
if (isset($_POST['cargar'])) {
  ...
  $tipo = $_POST['tipo'];
  $mes = $_POST['mes'];
  if ($anio == 0 or $materia == "0" or $tipo == "0" or $mes == "0") {
    $alertOn = 1;
    $resultado = 'ERROR: No se asignaron todos los campos, revise los selectores de Mes, Tipo, Año y Materia.';
    $alert = "alert-danger";
  } else {
...
<main label="subirtrabajosmesas">
  ...
  <section class="container">
    <div class="card shadow mb-5">
      <div class="card-header text-bg-success">Subir trabajos prácticos al sistema</div>
      <div class="card-body">
          ...
          <div class="row align-items-end">
            <div class="col-xxl-3 col-xl-3 col-lg-6 col-12">
              ...
              <select class="form-select" name="mes" id="mes" required>
                <option value="0" selected hidden>Mesa</option>
            ...
            <div class="col-xxl-3 col-xl-3 col-lg-6 col-12">
              ...
              <select class="form-select  input-control" name="materia" id="materias" required>
                <option value="0" selected hidden>Materia</option>
              </select>
            </div>
          </div>

                ...
                <div class="row g-0">
                    <div class="col-xxl-2 col-lg-2 col-6 mb-3 px-1">
                        ...
                        while ($divisiones = mysqli_fetch_array($div)) { ?>
                            <a type="button" class="btn btn-outline-success shadow w-100 py-2" href="periodosaberestpdire.php?anio=<?= $divisiones['anio'] ?>&division=<?= $divisiones['division'] ?>&turno=<?= $divisiones['turno'] ?> ">
                                <span>
                                    <?= $divisiones['nombre']; ?>
                                </span>
                            </a>

...
$planificacionesQ = "SELECT P.anio, M.nombre AS materia, P.aniolectivo, P.fechadecarga, P.cargadopornombre, P.archivo
            ...
            <?php if (mysqli_num_rows($planificacionesA) != 0) {
                while ($tps = mysqli_fetch_array($planificacionesA)) { ?>
                    <div class="row border-3 border-bottom border-success border-opacity-25 py-2">
                        ...
                        <div class="col-xl-2 col-12">
                            <a class="text-success" href="../docentes/programas/<?= $tps['archivo'] ?>"

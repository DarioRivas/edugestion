        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body p-0 g-0 small">
                <div class="row py-2 px-4 bg-success g-0">
                    ...
                    <div class="col fw-bold text-center">DESCARGAR</div>
                </div>
                    ...
                    <div class="row p-1 px-4 border-bottom align-items-center">
                        ...
                        <div class="col">
                            <?php if (!is_null($materias['archivo'])) { ?>
                                ...
                                <a href="descargar.php?id=<?= $materias['id'] ?>" target="_blank" class="btn btn-sm btn-success w-100 text-center d-flex align-items-center justify-content-center">
